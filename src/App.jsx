      ...
      <div className="flex flex-col min-h-screen bg-gray-100">
        ...
        <>
          <Routes>
            ...
            <Route path="/blog-View/:id" element={<div><BlogViewPage /> </div>} />
            <Route path="/IT" element={<div><BrandDetailPage /></div>} />
            <Route path="/media" element={<div> < MediaDetailPage /></div>} />
            <Route path="/Trade" element={<div><TradingDetailPage /></div>} />
          </Routes>
        </>
        <Footer />
      </div>
